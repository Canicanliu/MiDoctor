...
Page({
  ...
  mySelect(e) {
    ...
    var that = this    
    wx.request({
      url: 'http://localhost:8080/minidoctor/wx/business/getFutureArrange?hospital='+value+'&sessionId=' + wx.getStorageSync("miniSessionId"),
      method: "POST",
  ...
  submitDateMent: function(e) {
    ...
    var that=this
    wx.request({
      url: 'http://localhost:8080/minidoctor/wx/business/makeADate?sessionId=' + wx.getStorageSync("miniSessionId"),
      method: "POST",
      data:{
        workDate:date,
        name:userName,
  ...
  onLoad: function() {
    ...
    var header;
    wx.request({
      url: 'http://localhost:8080/minidoctor/wx/business/getFutureArrange?hospital=0&sessionId=' + wx.getStorageSync("miniSessionId"),
      method: "POST",
      success: function(result) {
        console.log(result)
        that.setData({
